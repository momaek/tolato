export default {
  ...
  settings: {
    ...
    oidc: {
      groupSync: '用户组同步',
      groupSyncHelp: '让 Tolato 的用户组跟随身份提供方，权限随目录自动生效。',
      groupClaim: 'Group claim',
      groupClaimHelp: '携带用户所属组的 ID token claim，通常是 "groups"。留空则关闭组同步。',
      idpGroup: '身份提供方的组',
      tolatoGroup: 'Tolato 用户组',
      addMapping: '添加映射',
      noUserGroups: '请先在「权限」页建好用户组，再回来映射。',
      title: '单点登录（OIDC）',
  ...
  permissions: {
    title: '权限',
    description: '决定谁能访问哪些机器，以及能做什么。',
    tabGrants: '授权',
    tabUserGroups: '用户组',
    tabNodeGroups: '节点组',
    grantsHelp: '每条授权把某个用户或用户组，按级别授予对节点、节点组或全部节点的访问权。',
    userGroupsHelp: '把人分组，授权一次即可覆盖全组，不必逐人配置。',
    nodeGroupsHelp: '把机器分组，一条授权覆盖整组——包括之后才加入的机器。',
    addGrant: '新建授权',
    addGroup: '新建分组',
    editGroup: '编辑分组',
    deleteGroup: '删除分组',
    deleteGroupWarning: '确定删除 {name}？其授权会一并删除，组内成员本身不受影响。',
    edit: '编辑',
    who: '谁',
    what: '可访问',
    level: '级别',
    ...
    selectAll: '全选',
    clearSelection: '清空',
    selectedCount: '已选 {count} 项，每项生成一条授权。',
    grantsSaved: '已保存 {count} 条授权。',
    allNodes: '全部节点',
    kindUser: '用户',
    kindUserGroup: '用户组',
    kindNode: '节点',
    ...
    levelOperator: '操作',
    levelManager: '管理',
    levelHelp: '只读：查看节点及其历史。操作：另可执行命令、开终端。管理：另可改名、升级、删除。',
    noGrants: '还没有授权。管理员始终可以访问全部节点。',
    noGroups: '还没有分组。',
    noCandidates: '暂无可添加项。',
    failedToLoad: '加载权限失败。',
    failedToSave: '保存失败。',
